...
def get_config():
    ...
    Network parameters:
        ...
        --use_transformer_base_actor <bool>
            by default False, for actor - will use CNN/MLP-based architecture; if set, will use Transformer-based architecture.
        --use_transformer_base_critic <bool>
            by default False, for critic - will use CNN/MLP-based architecture; if set, will use Transformer-based architecture.
        --hidden_size <int>
    ...
    parser.add_argument("--use_transformer_base_actor", action='store_true',
                        default=False, help="Whether to use transformer-based encoder for actor")
