...
exp="actor-only-transformer-base-ddcl"
...
--env_name ${env} --scenario_name ${scenario} --algorithm_name ${algo} --experiment_name ${exp} --seed 3 \
...
--use_transformer_base_actor --use_comms_channel --use_wandb False 
