...
from onpolicy.envs.predator_prey.PredatorPrey_env import PredatorPreyEnv
...
def parse_args(args, parser):
    parser.add_argument('--num_agents', type=int, default=5,
                        help="Number of predators in the environment")
    parser.add_argument('--nenemies', type=int, default=1,
                        help="Total number of preys in play")
    parser.add_argument('--nfriendly', type=int, default=1,
                        help="Total number of predators in play")
...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.predator_prey_runner import PredatorPreyRunner as Runner
    else:
