#!/bin/bash
"""
WandB Sweep Runner Script for TrafficJunction
Initializes the sweep and runs parallel agents
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run WandB sweep for TrafficJunction MARL')
